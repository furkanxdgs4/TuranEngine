...
namespace GFX_API {
	...
	*/
	...
	public:
		...
		GFX_Mesh* Find_MeshBuffer_byBufferID(unsigned int MeshBufferID);
		Framebuffer* Find_Framebuffer_byGFXID(unsigned int FB_ID);
		RenderTarget* Find_RenderTarget_byID(unsigned int RT_ID);
		GFX_Texture* Find_GFXTexture_byID(unsigned int Texture_AssetID);
		GFX_ShaderSource* Find_GFXShaderSource_byID(unsigned int ShaderSource_AssetID);
		GFX_ShaderProgram* Find_GFXShaderProgram_byID(unsigned int ShaderProgram_AssetID);
	};
}