...
namespace OpenGL4 {
	...
	void OpenGL4_Core::Show_RenderTarget_onWindow(unsigned int RenderTarget_GFXID) {
		TuranAPI::LOG_NOTCODED("OpenGL4_Core::Show_RenderTarget_onWindow isn't coded because glFramebufferTexture2D doesn't work on default Framebuffer of OpenGL!\n", true);
		glfwMakeContextCurrent(((WINDOW*)Main_Window)->GLFWWINDOW);
	...
	void Close_OGL4DLL() {
		...
		std::cout << "Finished closing GFX and OGL4DLL!\n";
