...
namespace GFX_API {
	...
	GFX_Core::GFX_Core() : CONNECTED_Monitors(LASTUSEDALLOCATOR, 1, 1), RENDERER(nullptr),
		FOCUSED_WINDOW_index(0), DEVICE_GPUs(LASTUSEDALLOCATOR, 1, 1), GPU_TO_RENDER(nullptr) {
