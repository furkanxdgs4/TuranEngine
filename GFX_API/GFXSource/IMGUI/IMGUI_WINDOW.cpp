...
namespace GFX_API {
	...
	IMGUI_WindowManager::IMGUI_WindowManager() : ALL_IMGUI_WINDOWs(LASTUSEDALLOCATOR, 1, 4), Windows_toClose(LASTUSEDALLOCATOR, 1, 4), Windows_toOpen(LASTUSEDALLOCATOR, 1, 4) {
